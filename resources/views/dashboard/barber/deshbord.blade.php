        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{count($apppoinmentConfirm)}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{count($apppoinmentPanding)}}<sup style="font-size: 20px"></sup></h3>

                <p>Confirm Appoinment</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3>{{count($apppoinmentComplate)}}</h3>

                <p>Complete Appoinment </p>
              </div>
              <div class="icon">
